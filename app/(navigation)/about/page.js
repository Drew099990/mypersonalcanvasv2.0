...
const Page = () => {
  ...
  return (
    <div className="h-fit bg-gray-300 flex justify-baseline p-5 items-center flex-col ">
      ...
      <div className="w-[60vw] z-30 shadow-2xl shadow-black/60 z-10 min-w-[65rem]  p-5 rounded-t-2xl h-[80vh] rounded-b-2xl from-[#2E2E2EFF] via-[#f2f2f2] to-[#2E2E2EFF] border-2 bg-gradient-to-t flex flex-col justify-center items-center">
...
༼ つ ◕_◕ ༽つ...hmmmm yeah about that give me a week or two (T_T)
        ...
        <div className=" left-35 max-[96rem]:hidden   bottom-10 border-l-8 border-t-8 rounded-[40%] rotate-270 text-transparent border-black text-[7rem] fixed ">f</div>
        <div className="border-b-12 max-[96rem]:hidden  border-t-2 left-20 opacity-75 overflow-hidden bottom-35 flex border-4 rounded-[40%] bg-black/90 bg-clip-border text-[8rem] fixed ">
          <button
            onClick={() => {
              setRole("vistor");
            }}
