...
const Sleepy = () => {
    ...
    const button = ["about",2,"skills",4,"achive",6,7,"vision",9,]
...
{ isON?  <div className='h-[80%] bg-gray-300 w-60 size-50 flex justify-center items-center '>
   {logo == true && <div><Image className='size-fit rounded-2xl' alt='sleepy panda company logo on phone' src={img}></Image>
    ...
    {message == "about" && <p className='flex justify-center items-center p-2'>i am a full stack web and game developer who focuses on bringing a unique creative feel to every project ,with 2 years experience perfecting and adapting new lessonsalong tthe way </p>}
