    ...
    <html lang="en">
      ...
      >
        <header className="bg-[#474a47] max-sm:justify-center flex min-sm:justify-between border-double border-t-12 border-b-12 ring-1 ring-white border-[#232323]/90 b p-3 shadow-2xl ">
          <Link href="/" className="max-md:hidden flex max-md:px-2 z-20 max-md:scale-95 items-center gap-3 bg-[#D2D0D0FF] w-fit rounded-2xl mx-4 px-2">
       ...
       <div >   <Link href="PaS" className="text-green-100 flex gap-2 font-sans opacity-60 px-3 m-3 py-1  border-green border ring-4 rounded-xl  ring-gray-800  font-bold italic text-balance bg-gray-500 mt-5 hover:scale-110 cursor-pointer min-md:hidden">Home</Link></div>
