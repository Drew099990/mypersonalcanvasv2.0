...
const Menu = () => {
 ...
 <div className="flex  gap-5 h-7 bordee max-[55rem]:scale-90 rounded-2xl px-4 p-1 border  border-gray-800 text-gray-300 ">
            ...
            <Link href="https://wa.me/+260777290515" className="font-bold  border-gray-600  border-x-2  px-2 leading-tight  opacity-50 bg-gradient-to-r from-green-900 to-[#474a47] hover:opacity-65 flex items-center gap-1" >hire <FaWhatsapp size={18} /></Link>
          </div>  
  )
}
