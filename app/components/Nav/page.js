...
const Menu = () => {
  return (
 <div className="flex  gap-5 h-7 max-[55rem]:scale-75  border-gray-600 text-gray-300 ">
            ...
            <Link href="https://wa.me/+260777290515" className="font-bold  border-gray-600  border-x-2  px-2 leading-tight  opacity-50 bg-gradient-to-r from-green-900 to-[#474a47] hover:opacity-65 flex items-center gap-1" >hire me <FaWhatsapp size={18} /></Link>
          </div>  
  )
}
